      ...
      <div className="max-w-5xl w-full bg-white rounded-2xl sm:rounded-3xl shadow-2xl border border-slate-200/80 overflow-hidden relative z-10 my-auto grid grid-cols-1 lg:grid-cols-12 min-h-[520px] lg:min-h-[640px]">
        ...
        <div className="lg:col-span-7 flex flex-col justify-between p-4 sm:p-7 lg:p-10 bg-white">
          <div className="space-y-5">
            ...
            {/* IDENTITAS RESMI GURU PENGAMPU (MENYATU PERMANEN & TIDAK BISA DIRUBAH) */}
            <div
              id="identitas-guru-login-resmi"
              className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-950 via-slate-900 to-emerald-900 p-3.5 sm:p-4 text-white shadow-lg border border-emerald-600/40"
            >
              {/* Decorative subtle ambient lights */}
              <div className="absolute top-0 right-0 -mr-6 -mt-6 w-32 h-32 rounded-full bg-amber-400/10 blur-xl pointer-events-none"></div>
              ...
              <div className="relative z-10 flex items-center gap-3.5 sm:gap-4">
                ...
                {/* Informasi Identitas Pendidik */}
                <div className="min-w-0 flex-1 space-y-1">
                  <div className="flex items-center gap-1.5 flex-wrap">
                    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-amber-400/20 border border-amber-400/50 text-[10px] sm:text-[11px] font-black text-amber-300 uppercase tracking-wider shadow-2xs">
                  ...
                  <h3 className="text-sm sm:text-base font-black text-white tracking-tight leading-snug drop-shadow-xs">
                    {teachers.nama || "Sadiqul Alim, S.Pd.I., M.Pd."}
                  </h3>

                  <div className="text-[11px] text-emerald-200/90 font-medium flex items-center gap-2 flex-wrap">
                    <span className="font-mono text-emerald-100 font-bold bg-emerald-900/80 px-1.5 py-0.5 rounded border border-emerald-700/60">
                      NIP. {teachers.nip || "197909172014071004"}
                    </span>
